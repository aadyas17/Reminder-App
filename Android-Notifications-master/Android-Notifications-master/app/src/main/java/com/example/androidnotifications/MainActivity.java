...
public class MainActivity extends AppCompatActivity {
    ...
    public void headsUpNotify(String task) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Notification channel for task reminders");
        ...
        Notification notification = new NotificationCompat.Builder(this, "channel02")
                .setSmallIcon(R.drawable.ic_notification_important) // Use your app's drawable icon
                .setContentTitle("Task Reminder")
                .setContentText(task) // Dynamic content based on user input
